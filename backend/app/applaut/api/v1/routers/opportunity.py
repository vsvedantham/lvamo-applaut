...
from app.applaut.schemas.opportunity import (
...
from app.applaut.services.opportunity import get_opportunity, list_opportunities_with_scores, trigger_discovery
